...
1. Download `runtimeClasses.jar` for your AIR SDK version (22 or 23) from the [air_sdk_patch](air_sdk_patch/) directory. Copy and paste it to `AIR_SDK_patched/lib/android/lib`, replacing the existing file.   
2. Download `adt.jar` for your AIR SDK version (22 or 23) from the [air_sdk_patch](air_sdk_patch/) directory. Copy and paste it to `AIR_SDK_patched/lib`, replacing the existing file.   
